        ...
        <Menu onOpenChange={(e) => e.stopPropagation()}>
          <MenuTrigger disableButtonEnhancement>
            <Tooltip content="More actions" relationship="description" hideDelay={0}>
              <MenuButton appearance="transparent" icon={<MoreHorizontalRegular />} className={css.menuButton} />
            </Tooltip>
          </MenuTrigger>
            ...
            <MenuList>
              <MenuItem
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  window.open(
                    `vscode://apidev.azure-api-center?clientId=${dataApiClientId}&tenantId=${dataApiTenantId}&runtimeUrl=${dataApiEndpoint}`
                  );
                }}
              >
