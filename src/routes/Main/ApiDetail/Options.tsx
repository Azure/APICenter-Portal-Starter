...
const Options: FC<{ api: Api; version?: string; definition?: string; environment?: Environment }> = ({
  api,
  version,
  definition,
  environment,
          ...
          <div className={css.option}>
            ...
            <div className={css.optionInfo}>
              <div className={css.title}>
                ...
                {schemaUrl && (
                  <>
                    ...
                    <Link
                      className={css.link}
                      onClick={() => navigate(`/swagger/${api.name}/${version}/${definition}`)}
                    >
              ...
              <Body1 className={css.description}>
                This file defines how to use the API, including the endpoints, policies, authentication, and responses.
              </Body1>
              <div className={css.buttonsWrapper}>
                <Button icon={<VsCodeLogo />} onClick={() => window.open(`vscode:extension/apidev.azure-api-center`)}>
              ...
              <div className={css.option}>
                ...
                <div className={css.optionInfo}>
                  <div className={css.title}>
                    ...
                    {(environment.onboarding.developerPortalUri?.length ?? 0) > 0 && (
                      <>
                        ...
                        <Link
                          href={environment.onboarding?.developerPortalUri?.[0]}
                          target="_blank"
                          className={css.link}
                        >
                  ...
                  {environment.onboarding.instructions ? (
                    ...
                    <Body1 className={css.description}>Gain comprehensive insights into the API.</Body1>
                  )}
                </div>
              </div>
            </>
