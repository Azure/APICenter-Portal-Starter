...
const VsCodeInsidersLogo = () => (
    <svg xmlns={"http://www.w3.org/2000/svg"} height={"24"} viewBox={"-11.9 -2 1003.9 995.6"} width={"24"}>
        <path
        ...
        <path
            ...
            fill={"#21b397"}
        />
        <path d={"m451.9 500 292.7-223.5-1.9-223.6s-12.5-48.8-54.2-23.4l-389.5 354.5z"} fill={"#1ea588"} />
        <path
            d={
...
export default VsCodeInsidersLogo;
